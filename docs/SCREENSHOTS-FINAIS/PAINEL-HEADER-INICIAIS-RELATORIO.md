# Painel Médico — Header institucional + iniciais pacientes

**Gerado em:** 2026-05-30T23:22:31.491Z
...
- `painel-header-iniciais-depois-1280x720.png`
- `painel-header-iniciais-antes-1280x720.png`
- `painel-header-iniciais-antes-depois.png`
